var controller = (function(LSCtrl, UICtrl){
	...
	var DrawLewisStructure = function(){
		...
		var sketch = function(p){
			...
			p.draw = function(){
				p.background(200,300,200)
				UICtrl.drawCentralAtom(p, LewisStructure.centralAtom.symbol)
				var outerelements = LewisStructure.elements.filter(function(element){ return element !=LewisStructure.centralAtom})
				var bond_positions = UICtrl.drawOuterElements(p, outerelements)
				UICtrl.drawBonds(p, outerelements, bond_positions)
